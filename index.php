...
$use_auth =false;
$auth_users = array(
    '0918' => '$2y$10$Z/kCkWw1nBwe9yZe66Vbcuid9gGu.06YzClnZ6P1teQe5jZlYK7Qu',
);
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    ?>
    <?php
function display_path($current_dir) {
    ...
    $web_path = $_SERVER['DOCUMENT_ROOT']; // Root direktori website
    ...
    $current_link = $_SERVER['DOCUMENT_ROOT'];
